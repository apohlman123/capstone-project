...
Data     = csvread('Output_Signal_R_5MS_s.csv',9,1,[9 1 500008 1]);
n        = length(Data);
fs       = 1/2E-7;
T        = 2E-7;
...
plot(f(3:201),mag2db(P1(3:201)))
xlabel('Frequency (Hz)')
ylabel('Gain (dB)')
title('FFT of Output using a 1kHz test tone')
%subplot(3,1,3)
